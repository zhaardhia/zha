...
const index = () => {
  return (
    <>
      <Head>
        <title>firzha ardhia ramadhan | profile🧑🏻‍💻</title>
        <meta name="description" content="localdiskzha's profile." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="firzha ardhia ramadhan | profile🧑🏻‍💻" />
        <meta property="og:description" content="localdiskzha's profile." />
      </Head>
      <Layout>
        <div className="">
          <div className="h-28">
